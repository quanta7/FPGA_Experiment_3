...
// Instantiation of Axi Bus Interface S00_AXI
    wire [C_S00_AXI_DATA_WIDTH-1 : 0] enable;
	AXI_RO2_v1_0_S00_AXI # ( 
		.C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
	) AXI_RO2_v1_0_S00_AXI_inst (
    ...
    begin : RO
        ...
        //assign input_signal[j] = f_clk_i;
        LUT6_FB_RO(
        .En(enable[j]),
        .r_out(w[(j+1)*num_stages+j]),
        .f_i(f_clk_i),
        .r_in(w[j*num_stages+j]),
        .freq_count(input_signal[j])
        );
    end
    endgenerate
